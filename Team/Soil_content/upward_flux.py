...
print(calculate_upward_flux(
    ...
    soil_water_content_of_evap_layer_at_previous_step = 62.5,
    soil_water_content_of_transp_layer_at_previous_step = 37.5,
    soil_water_content_of_trans_layer_at_previous_step = 37.5,
