...
from main_interception_Gash import (
...
#equation 4
Psat4 = saturated_precipitation(
      canopy_storage_capacity = 0.252,
      canopy_cover = 0.5,
      Evaporation_to_Rainfall_Ratio = 0.02
)

kp4 = ratio_of_trunk_Storage_Capacity_to_stem_flow(
      trunk_Storage_Capacity = 0.157,
      stem_flow = 1.12
)
...
#equation 3
Psat3 = saturated_precipitation(
      canopy_storage_capacity = 0.252,
      canopy_cover = 0.5,
      Evaporation_to_Rainfall_Ratio = 0.02
)

kp3 = ratio_of_trunk_Storage_Capacity_to_stem_flow(
